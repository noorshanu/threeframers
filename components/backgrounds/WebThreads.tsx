...
export const WebThreads = ({
  ...
  useEffect(() => {
    ...
    ;(u.uMirror as { value: number }).value = mirror ? 1.0 : 0.0
    ;(u.uShimmer as { value: number }).value = shimmer ? 1.0 : 0.0
    ...
    const bgUniform = u.uBackgroundColor.value as Float32Array
    bgUniform[0] = bg[0]
    bgUniform[1] = bg[1]
    bgUniform[2] = bg[2]
    ...
    ;(u.uEnableMouse as { value: number }).value = mouseInteraction ? 1.0 : 0.0
